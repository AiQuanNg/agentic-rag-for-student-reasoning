...
**For Question (What is generative AI and how does it work?):**
- "Definition of generative AI" - Student explains WHAT generative AI is (definition, characteristics, capabilities)
- "How it gathers information" - Student explains HOW it works (training process, mechanisms, data collection, neural networks, transformers)
...
{
  "topic": ["Definition of generative AI", "How it gathers information"],
